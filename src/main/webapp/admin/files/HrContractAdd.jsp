    ...
    <script type="text/javascript">
        ...
        function submitHrContractAdd() {
            ...
            $.post("${pageContext.request.contextPath}/hrContract/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","合同添加成功");
                    }else{
                        $.messager.alert("系统提示","合同添加失败");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="合同添加" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrContractAdd()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">添加合同</a></td>
        </tr>
    </table>
</div>
</body>
