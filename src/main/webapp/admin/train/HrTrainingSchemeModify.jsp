...
<head>
    ...
    <script type="text/javascript">
        ...
        /**培训方案修改*/
        function submitHrTrainingSchemeModify() {
            ...
            $.post("${pageContext.request.contextPath}/hrTrainingScheme/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","培训方案修改成功");
                    }else{
                        $.messager.alert("系统提示","培训方案修改失败");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="培训方案修改" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrTrainingSchemeModify()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">修改培训方案</a></td>
        </tr>
    </table>
</div>
<script type="text/javascript">

    $.post("${pageContext.request.contextPath}/hrTrainingScheme/findById.do",
        {"id":"${param.id}"},
        function(result){
            result = eval("("+result+")");
