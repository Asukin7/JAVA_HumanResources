    ...
    <script type="text/javascript">
        ...
        function submitHrFilesModify() {
            ...
            $.post("${pageContext.request.contextPath}/hrFiles/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","档案修改成功！");
                    }else{
                        $.messager.alert("系统提示","档案修改失败！");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="档案修改" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrFilesModify()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">修改档案</a></td>
        </tr>
    </table>
</div>
<script type="text/javascript">

    $.post("${pageContext.request.contextPath}/hrFiles/findById.do",
        {"id":"${param.id}"},
        function(result){
            result = eval("("+result+")");
