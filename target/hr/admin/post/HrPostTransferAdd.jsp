...
<head>
    ...
    <script type="text/javascript">
        ...
        /**岗位调动添加*/
        function submitHrPostTransferAdd() {
            ...
            $.post("${pageContext.request.contextPath}/hrPostTransfer/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","岗位调动添加成功");
                    }else{
                        $.messager.alert("系统提示","岗位调动添加失败");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="岗位调动添加" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrPostTransferAdd()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">添加岗位调动</a></td>
        </tr>
    </table>
</div>
</body>
