...
<head>
    ...
    <script type="text/javascript">
        ...
        /**技能鉴定添加*/
        function submitHrSkillAppraisalAdd() {
            ...
            $.post("${pageContext.request.contextPath}/hrSkillAppraisal/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","技能鉴定添加成功");
                    }else{
                        $.messager.alert("系统提示","技能鉴定添加失败");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="技能鉴定添加" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrSkillAppraisalAdd()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">添加技能鉴定</a></td>
        </tr>
    </table>
</div>
</body>
