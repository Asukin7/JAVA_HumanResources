    ...
    <script type="text/javascript">
        ...
        function submitHrWagesAdd() {
            ...
            $.post("${pageContext.request.contextPath}/hrWages/save.do",
                ...
                function(result){
                    if(result.success){
                        $.messager.alert("系统提示","工资信息添加成功");
                    }else{
                        $.messager.alert("系统提示","工资信息添加失败");
                    }
                },"json");
        }
...
<div id="p" class="easyui-panel" title="工资信息添加" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td></td>
            <td><a href="javascript:submitHrWagesAdd()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">添加工资信息</a></td>
        </tr>
    </table>
</div>
</body>
